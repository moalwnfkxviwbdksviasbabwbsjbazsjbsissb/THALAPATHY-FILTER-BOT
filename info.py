...
API_ID = int(environ.get('API_ID', '26286754'))
API_HASH = environ.get('API_HASH', '7a637e05958e14496e6ab1910a9eb9e7')
BOT_TOKEN = environ.get('BOT_TOKEN', "6072750107:AAGCAaTGcXjiiex8CwxmzfvHxSbbAZo8lW8")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1420974008').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001975125149').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://levi303:levi303@cluster0.ws4aofd.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "levi313")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001975125149'))
